...
test_that("pooled ipw works", {
  ...
  z1_est_expected <- c(-0.01192126, -0.01611274, -0.02030422, -0.02449570, -0.02868719, -0.03287867, -0.03707015, -0.04126164,
...
test_that("nonpooled ipw works", {
  ...
  z1_est_expected <- c(0.185840821, -0.443490959, -0.464866890, -0.013478042, -0.004946504, -0.386224477,  0.279217008,
